class Solution {
  ...
  public int[] twoSum(int[] nums, int target) {
    ...
    /*
      ...
      seeing the result value needed to complement it is already avaialble in the map. 
      the map lookup is constant time and if availalbe we return or else add the current number to the map
    */
    for(int i = 0; i < nums.length; i++) {
